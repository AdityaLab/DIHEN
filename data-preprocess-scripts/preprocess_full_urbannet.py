...
def preprocess_failure_model(filedir,edgefile):
    ...
    es_volt=es_info_data['MIN_VOLT'].values
...
if __name__=='__main__':
    ...
    filedir='data/v9/urbannet-api-graph/'#'data/toy/' #sys.argv[1]
    edge_file='urbannet_edges_rule_based_pj_p_v2' #added substation volts
    preprocess_failure_model(filedir,edge_file)
